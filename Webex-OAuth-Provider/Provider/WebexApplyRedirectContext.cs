...
namespace Owin.Security.Providers.Webex
{
    ...
    public class WebexApplyRedirectContext : BaseContext<WebexAuthenticationOptions>
    {
        /// <summary>
        ...
        public WebexApplyRedirectContext(IOwinContext context, WebexAuthenticationOptions options,

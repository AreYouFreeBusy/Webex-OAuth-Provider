...
{
    public class WebexAuthenticationHandler : AuthenticationHandler<WebexAuthenticationOptions>
    {
        // see https://developer.webex.com/docs/integrations for docs 
        private const string AuthorizeEndpoint = "https://webexapis.com/v1/authorize";
        private const string TokenEndpoint = "https://webexapis.com/v1/access_token";
        private const string UserInfoEndpoint = "https://webexapis.com/v1/people/me";
        private const string XmlSchemaString = "http://www.w3.org/2001/XMLSchema#string";

        private readonly HttpClient _httpClient;
        private readonly ILogger _logger;

        public WebexAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new WebexAuthenticatedContext(Context, accessToken, expires, refreshToken, userJson);
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                var beforeRedirectContext = new WebexBeforeRedirectContext(Context, Options);
                ...
                var redirectContext =
                    new WebexApplyRedirectContext(Context, Options, properties, authorizationEndpoint);
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new WebexReturnEndpointContext(Context, ticket);
